...
# homeservices endpoints
  ...
  it 'search single business' do
    business = BusinessesSearchService.find_business('LXlVCu6G-buaxC8GlDjmLA')
    ...
    expect(business).to have_key(:image)
    ...
    expect(business[:review_count]).to be_a(Integer)
    ...
    expect(business[:location]).to have_key(:address1)
    expect(business[:location][:address1]).to be_a(String)
    expect(business[:location]).to have_key(:address2)
    expect(business[:location][:address2]).to be_a(String)
    expect(business[:location]).to have_key(:address3)
    expect(business[:location][:address3]).to be_a(String)
    expect(business[:location]).to have_key(:city)
    expect(business[:location][:city]).to be_a(String)
    expect(business[:location]).to have_key(:zip_code)
    expect(business[:location][:zip_code]).to be_a(String)
    expect(business[:location]).to have_key(:country)
    expect(business[:location][:country]).to be_a(String)
    ...
    expect(business).to have_key(:distance)
    expect(business[:distance]).to be_a(Float).or eq(nil)
  end
end
